...
namespace TLLib
{
    public class ProductDownload
    {
        ...
        public int ProductDownloadInsert(
            ...
            string Model,
            string FlowRate,
            string SaltRejection,
            string DiameterLength,
        ...
        )
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Model", string.IsNullOrEmpty(Model) ? dbNULL : (object)Model);
                cmd.Parameters.AddWithValue("@FlowRate", string.IsNullOrEmpty(FlowRate) ? dbNULL : (object)FlowRate);
                cmd.Parameters.AddWithValue("@SaltRejection", string.IsNullOrEmpty(SaltRejection) ? dbNULL : (object)SaltRejection);
                cmd.Parameters.AddWithValue("@DiameterLength", string.IsNullOrEmpty(DiameterLength) ? dbNULL : (object)DiameterLength);
                cmd.Parameters.AddWithValue("@TestCondition", string.IsNullOrEmpty(TestCondition) ? dbNULL : (object)TestCondition);
