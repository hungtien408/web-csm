<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="infofollow.aspx.cs" Inherits="ad_single_product" %>
                                                ...
                                                <table class="search">
                                                    <tr>
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 25px x 24px)</span>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchPriceTo" Name="PriceTo" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter DefaultValue="18" ControlID="ddlSearchCategory" Name="CategoryID" PropertyName="SelectedValue"
                Type="String" />
