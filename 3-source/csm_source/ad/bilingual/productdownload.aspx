    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" AllowPaging="True"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn HeaderText="ID" DataField="ProductDownloadID" SortExpression="ProductDownloadID" Visible="false">
                    </asp:GridBoundColumn>
                    ...
                    <asp:GridBoundColumn HeaderText="Model" SortExpression="Model" DataField="Model" />
                    <asp:GridBoundColumn HeaderText="FlowRate" SortExpression="FlowRate" DataField="FlowRate" />
                    <asp:GridBoundColumn HeaderText="SaltRejection" SortExpression="SaltRejection" DataField="SaltRejection" />
                    <asp:GridBoundColumn HeaderText="DiameterLength" SortExpression="DiameterLength" DataField="DiameterLength" />
                    <asp:GridBoundColumn HeaderText="TestCondition" SortExpression="TestCondition" DataField="TestCondition" />
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Download</h3>
                            <table class="search">
                                <tr>
                                    <td class="left" valign="top">Chọn File
                                    </td>
                                    <td>
                                ...
                                <tr class="invisible">
                                    <td class="left" valign="top">Tiêu đề(En)
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="left" valign="top">Model
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtModel" runat="server" Width="500px" Text='<%# Bind("Model") %>'></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left" valign="top">FlowRate
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtFlowRate" runat="server" Width="500px" Text='<%# Bind("FlowRate") %>'></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left" valign="top">SaltRejection
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtSaltRejection" runat="server" Width="500px" Text='<%# Bind("SaltRejection") %>'></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left" valign="top">DiameterLength
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtDiameterLength" runat="server" Width="500px" Text='<%# Bind("DiameterLength") %>'></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="left" valign="top">TestCondition
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtTestCondition" runat="server" Width="500px" Text='<%# Bind("TestCondition") %>'></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductDownloadSelectAll"
            ...
            <InsertParameters>
                ...
                <asp:Parameter Name="FlowRate" Type="String" />
                <asp:Parameter Name="SaltRejection" Type="String" />
                <asp:Parameter Name="DiameterLength" Type="String" />
                <asp:Parameter Name="TestCondition" Type="String" />
