<%@ Page Title="" Language="C#" MasterPageFile="~/en/site-sub.master" AutoEventWireup="true" CodeFile="san-pham-chi-tiet.aspx.cs" Inherits="san_pham_chi_tiet" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="site" class="corner">
        <div class="">
            <a id="A4" href="~/" runat="server"><i class="fa fa-home"></i></a>/<a id="A1" href="san-pham.aspx">Product</a>/<asp:Label ID="lblName" runat="server" Text=""></asp:Label>
        </div>
    </div>
    <div class="clr"></div>
                    ...
                    <div class="content_pro_tit">
                        ...
                        <div class="call-us">
                            ...
                            <asp:ListView ID="lstHotline" runat="server" DataSourceID="odsHotline2"
                                ...
                                <ItemTemplate>
                                    <p>
                                        Price contact:<span> <%# Eval("Tag") %></span>
                                    </p>
                                </ItemTemplate>
                                <LayoutTemplate>
